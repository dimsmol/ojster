...
Generator.prototype.openBlock = function(ctx, blockName, blockArgs, closeImmediately) {
    ...
    if (this.currentBlock) {
        this.appendCallBlock(ctx, block, blockArgs);
    }
...
Generator.prototype.appendCallBlock = function(ctx, block, args) {
	if (!args) {
		args = '';
	}

    this.closeSequenceIfNeed(ctx);
    this.currentBlock.append(this.indentStr, this.thisAlias, '.', this.getBlockFunctionName(block), '(', args, ');');
