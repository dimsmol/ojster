...
Generator.prototype.appendRequire = function(ctx, alias, path, subpath, fullName) {
...
Generator.prototype.setInheritanceInfo = function(ctx, templateBaseAlias, templateBaseFullName) {
	if (this.currentBlock) {
...
Generator.prototype.appendBlockDefinitionStart = function(ctx) {
    ...
    this.currentBlock.append(
        this.templateNameToUse, '.prototype.', this.getBlockFunctionName(this.currentBlock),
        ' = function() {'
    );
