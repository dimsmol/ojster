...
Generator.prototype.appendBaseCall = function(ctx, args) {
	if (!this.inheritsAdded) {
    ...
    this.currentBlock.append(
		this.indentStr,
		this.templateBaseNameToUse, '.prototype.', this.getBlockFunctionName(this.currentBlock.name),
		'.call(', this.thisAlias, args, ');'
	);
};
