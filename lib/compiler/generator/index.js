...
var Generator = function(options, errors) {
    ...
    this.defaultTemplateBasePath = options.defaultTemplateBasePath || "'ojster/lib/template'";
    this.defaultTemplateBaseSubObject = options.defaultTemplateBaseSubObject || null;
    this.defaultTemplateBaseNamespace = options.defaultTemplateBaseNamespace || 'ojster';
    ...
    this.appendFunctionStr = options.appendFunctionStr || 'append';
...
Generator.prototype.appendTemplateBaseRequire = function() {
    ...
    this.appendRequireTo(this.requireTemplateBaseBuffer, null,
        ...
        this.templateBaseSubObject,
        this.templateBaseFullName
    );
    this.requireTemplateBaseBuffer.append('\n');
};
...
Generator.prototype.appendMissing = function() {
    if (!this.inheritsAdded) {
		// use default template base
	    this.templateBase = this.defaultTemplateBase;
		this.templateBasePath = this.defaultTemplateBasePath;
		this.templateBaseSubObject = this.defaultTemplateBaseSubObject;
		this.templateBaseNamespace = this.defaultTemplateBaseNamespace;
		this.templateBaseFullName = this.getTemplateBaseFullName();
	}
...
Generator.prototype.appendRenderTo = function(buffer) {
    buffer.append(
        '\n\n',
		this.templateFullName, '.render = function() {\n',
		this.indentStr, 'var instance = new ', this.templateFullName, '();\n',
		this.indentStr, 'instance.init.apply(instance, arguments);\n',
...
Generator.prototype.getTemplateBaseFullName = function() {
	...
	return this.defaultTemplateBase;
};
