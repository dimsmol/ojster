...
var FunctionStart = function(ctx, name, args, endImmediately, opt_isStatic, opt_isInit) {
	this.ctx = ctx;
	this.name = name;
	this.args = args;
	this.endImmediately = endImmediately;
	this.isStatic = !!opt_isStatic;
...
var FunctionEnd = function(ctx, name, opt_isStatic, opt_isInit) {
	this.ctx = ctx;
	this.name = name;
	this.isStatic = !!opt_isStatic;
	this.isInit = !!opt_isInit;
