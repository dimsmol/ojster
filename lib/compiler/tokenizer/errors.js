...
mt.mark(TokenizationError, ':TokenizationError');
...
mt.mark(CloseInstructionMarkMissed, ':CloseInstructionMarkMissed');
...
mt.mark(UnknownCommand, ':UnknownCommand');
...
mt.mark(InvalidCommandSyntax, ':InvalidCommandSyntax');
