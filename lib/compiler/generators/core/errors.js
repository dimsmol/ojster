...
mt.mark(GenerationError, 'ojster:GenerationError');
...
mt.mark(TemplateTokenNotFound, 'ojster:TemplateTokenNotFound');
...
mt.mark(InheritsTokenNotFound, 'ojster:InheritsTokenNotFound');
...
mt.mark(DuplicateInheritsToken, 'ojster:DuplicateInheritsToken');
...
mt.mark(IncorrectCodeMarkupWithinFunction, 'ojster:IncorrectCodeMarkupWithinFunction');
...
mt.mark(TokenMustBePlaced, 'ojster:TokenMustBePlaced');
...
mt.mark(TokenMustBeWithin, 'ojster:TokenMustBeWithin');
...
mt.mark(TokenMustBeBeyond, 'ojster:TokenMustBeBeyond');
...
mt.mark(TokenMustBeWithinTemplate, 'ojster:TokenMustBeWithinTemplate');
...
mt.mark(TokenMustBeBeyondTemplate, 'ojster:TokenMustBeBeyondTemplate');
...
mt.mark(TokenMustBeBeyondFunction, 'ojster:TokenMustBeBeyondFunction');
...
mt.mark(TokenMustBeWithinBlock, 'ojster:TokenMustBeWithinBlock');
...
mt.mark(TokenMustBeBeyondBlock, 'ojster:TokenMustBeBeyondBlock');
...
mt.mark(DuplicateBlockName, 'ojster:DuplicateBlockName');
...
mt.mark(ClosedWithoutOpenning, 'ojster:ClosedWithoutOpenning');
...
mt.mark(FunctionClosedWithoutOpenning, 'ojster:FunctionClosedWithoutOpenning');
...
mt.mark(BlockClosedWithoutOpenning, 'ojster:BlockClosedWithoutOpenning');
