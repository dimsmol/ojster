...
Block.prototype.end = function(opt_token) {
	...
	{
		throw new errors.BlockClosedWithoutOpenning(opt_token.ctx, opt_token.name);
	}
...
Block.prototype.appendBaseCall = function(token) {
	...
	this.template.appendBaseCall(token.ctx, blockFuncName, token.args, this.options.thisAlias, this.buffer);
};
...
Block.prototype.appendGetCssNameFunctionFullStr = function() {
	this.buffer.push(this.options.thisAlias, '.', this.options.css.getCssNameFuncStr);
};
